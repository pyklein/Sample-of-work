    ...
    */
    DragZoom.prototype.onMouseMove_ = function(e) {
        ...
        if (this.dragging_) {
            ...
            if (width - (this.boxBorderWidths_.left + this.boxBorderWidths_.right) < 0)
                this.boxDiv_.style.width = 0 + "px";
            else
                this.boxDiv_.style.width = width - (this.boxBorderWidths_.left + this.boxBorderWidths_.right);
            if (height - (this.boxBorderWidths_.top + this.boxBorderWidths_.bottom) >= 0)
                this.boxDiv_.style.height = (height - (this.boxBorderWidths_.top + this.boxBorderWidths_.bottom)) + "px";
            else
                this.boxDiv_.style.height = 0 + "px";
    ...
    DragZoom.prototype.onMouseUp_ = function(e) {
        ...
        if (this.dragging_) {
            ...
            */
            ...
            erpMarkerCollection.inBound(sw, ne);
        }
    };
    /**
    * Handle key up.
