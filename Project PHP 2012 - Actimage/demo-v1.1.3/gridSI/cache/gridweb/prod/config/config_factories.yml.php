...
// date: 2016/10/06 07:29:09
  ...
  'cache_dir' => 'C:\\wamp\\www\\demo-v1.1.3\\gridSI\\cache\\gridweb\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\wamp\\www\\demo-v1.1.3\\gridSI\\apps\\gridweb/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('mindef-grid'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'mindef-grid',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\wamp\\www\\demo-v1.1.3\\gridSI\\cache\\gridweb\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\wamp\\www\\demo-v1.1.3\\gridSI\\apps\\gridweb/template',
)));
