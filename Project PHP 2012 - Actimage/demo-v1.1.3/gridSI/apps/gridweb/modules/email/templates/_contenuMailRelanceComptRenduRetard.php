...
<html>
  <body>
    <div>
      ...
      Compte-Rendu : à renseigner<br/>
      Echéance prévue le <?php echo formatDate($objDossier->getEcheance()->getDateEcheanceCr())?> - En retard - Relancé le <?php echo formatDate($strDateReferance)?><br/>
      <br/>
