...
<?php include_partial('dossier_mip/vue_dossier_mip', array('strId' => $strId, 'ongletActif' => 1)) ?>

<div id="zone_cadre">

  <?php include_component("dossier_mip", "voirDescriptionDossier_mip", array("id" => $strId)); ?>
