...
<?php include_partial('dossier_mip/vue_dossier_mip', array('strId' => $strId, 'ongletActif' => 3)) ?>

<div id="zone_cadre">

  <?php include_component("dossier_mip", "voirValorisationDossier_mip", array("id" => $strId)); ?>
