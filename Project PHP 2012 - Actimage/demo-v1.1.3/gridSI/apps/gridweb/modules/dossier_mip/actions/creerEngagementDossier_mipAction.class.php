...
/**
 * Description of creerEngagementDossier_mipAction
 *
 * @author Simeon Petev
 */
class creerEngagementDossier_mipAction extends gridAction
{
  ...
  public function execute($request)
  {
    ...
    $this->objForm = new EngagementForm();
    ...
    if ($this->getRequest()->isMethod('post'))
    {
      ...
      if ($this->processForm('creer', '', false))
      {
        ...
        $this->redirect(url_for('dossier_mip/listerEngagementDossier_mips?dossier_mip='.$this->objDossier->getId()));
      }
    }
