...
/**
 * Description of creerPaiementDossier_mipAction
 *
 * @author Simeon Petev
 */
class creerPaiementDossier_mipAction extends gridAction
{
  ...
  public function execute($request)
  {
    ...
    if ($this->getRequest()->isMethod('post'))
    {
      ...
      if ($this->processForm('creer', '', false))
      {
        ...
        $this->redirect(url_for('dossier_mip/listerPaiementDossier_mips?dossier_mip='.$this->objDossier->getId()));
      }
    }
