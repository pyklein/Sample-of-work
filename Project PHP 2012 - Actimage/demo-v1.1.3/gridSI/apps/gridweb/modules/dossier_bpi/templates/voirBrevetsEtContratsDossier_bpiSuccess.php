...
<?php include_partial('dossier_bpi/vue_dossier_bpi', array('strId' => $strId, 'ongletActif' => 3)) ?>

<div id="zone_cadre">

  <?php include_component("dossier_bpi", "voirBrevetsEtContratsDossier_bpi", array("id" => $strId)); ?>
