...
/**
 * Modification des contentieux d'un dossier BPI
 *
 * @author Alexandre WETTA
 */
class modifierContentieuxAction extends gridAction {
  ...
  public function execute($request) {
    ...
    if ($this->dossierBpi) {
      ...
      if (count($arrPartInventive) != 0) {
        ...
        $this->objForm = new ContentieuxPrincipalForm($objPartInventiveCourante->getId(), $this->dossierBpi);
