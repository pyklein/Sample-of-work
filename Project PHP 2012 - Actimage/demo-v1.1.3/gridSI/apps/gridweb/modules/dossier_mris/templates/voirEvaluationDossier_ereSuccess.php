...
<?php include_partial('dossier_mris/onglets_recapitulatif_dossier_ere', array('strId' => $strId, 'ongletActif' => 2, 'isProposition'=>$isProposition, 'hasCredentialsEvaluation'=>$hasCredentialsEvaluation)) ?>
