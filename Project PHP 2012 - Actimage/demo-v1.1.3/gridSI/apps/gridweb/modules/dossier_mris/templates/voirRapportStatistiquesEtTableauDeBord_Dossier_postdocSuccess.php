  ...
  <tr>
    ...
    <!--Groupement Répartition par domaines scientifiques-->
      <?php if (isset($chartPropositionDS)):?>
        <fieldset>
          <legend>
            <?php echo libelle("msg_statistiques_postdoc_proposition_dom_scientifiques") ?>
          </legend>
            <div class="right">
              <?php echo link_to_grid(libelle("msg_bouton_export_csv"),'dossier_mris/exporterRapportStatistiqueCSV?typeStat=Proposition_DS&typeDossier=Dossier_postdoc',array("class" => "picto bt_export_csv", "title"=>libelle("msg_bouton_export_csv"))); ?>
            </div>
  ...
  <tr>
    <td colspan="2">
      <?php if (isset($chartDossierDS)):?>
        <fieldset>
          <legend>
            <?php echo libelle("msg_statistiques_postdoc_dossier_dom_scientifiques") ?>
          </legend>
            <div class="right">
              <?php echo link_to_grid(libelle("msg_bouton_export_csv"),'dossier_mris/exporterRapportStatistiqueCSV?typeStat=Dossier_DS&typeDossier=Dossier_postdoc',array("class" => "picto bt_export_csv", "title"=>libelle("msg_bouton_export_csv"))); ?>
            </div>
  ...
  <tr>
    <td colspan="2">
      ...
      <?php if (isset($chartRegion)):?>
        <fieldset>
          <legend>
            <?php echo libelle("msg_statistiques_postdoc_region") ?>
          </legend>
            <div class="right">
              <?php echo link_to_grid(libelle("msg_bouton_export_csv"),'dossier_mris/exporterRapportStatistiqueCSV?typeStat=region&typeDossier=Dossier_postdoc',array("class" => "picto bt_export_csv", "title"=>libelle("msg_bouton_export_csv"))); ?>
            </div>
  ...
  <tr>
    <td class="width_cinquante top">
      ...
      <?php if (isset($chartPropositionOrigine)):?>
        <fieldset>
          <legend>
            <?php echo libelle("msg_statistiques_postdoc_proposition_origine") ?>
          </legend>
            <div class="right">
              <?php echo link_to_grid(libelle("msg_bouton_export_csv"),'dossier_mris/exporterRapportStatistiqueCSV?typeStat=proposition_origine&typeDossier=Dossier_postdoc',array("class" => "picto bt_export_csv", "title"=>libelle("msg_bouton_export_csv"))); ?>
            </div>
    ...
    <td class="width_cinquante top">
      ...
      <fieldset>
        <legend>
          <?php echo libelle("msg_statistiques_postdoc_dossier_origine") ?>
        </legend>
          <div class="right">
            <?php echo link_to_grid(libelle("msg_bouton_export_csv"),'dossier_mris/exporterRapportStatistiqueCSV?typeStat=dossier_origine&typeDossier=Dossier_postdoc',array("class" => "picto bt_export_csv", "title"=>libelle("msg_bouton_export_csv"))); ?>
          </div>
...
<?php if($intTotalProposition > 0 ):?>
  <fieldset>
    ...
    <div class="right">
       <?php echo link_to_grid(libelle("msg_bouton_export_csv"),'dossier_mris/exporterRapportStatistiqueCSV?typeStat=organisme&typeDossier=Dossier_postdoc',array("class" => "picto bt_export_csv", "title"=>libelle("msg_bouton_export_csv"))); ?>
    </div>
