...
<?php include_partial('dossier_mris/onglet_dossier', array('strNomModel' => 'Dossier_postdoc', 'strId' => $strId, 'ongletActif' => 1)) ?>
...
<?php include_partial('autreActionsMris',array('strNomModel'=>'Dossier_postdoc', 'id' => $strId)) ?>
