...
<?php include_partial('dossier_mris/onglets_recapitulatif_dossier_these', array('strId' => $strId, 'ongletActif' => 3, 'isProposition'=>$isProposition, 'hasCredentialsEvaluation'=>$hasCredentialsEvaluation)) ?>
