...
<?php include_partial('dossier_mris/onglets_recapitulatif_dossier_these', array('strId' => $strId, 'ongletActif' => 2, 'isProposition'=>$isProposition, 'hasCredentialsEvaluation'=>$hasCredentialsEvaluation)) ?>
