...
<?php include_partial('dossier_mris/onglets_recapitulatif_dossier_postdoc', array('strId' => $strId, 'ongletActif' => 1, 'isProposition'=>$isProposition, 'hasCredentialsEvaluation'=>$hasCredentialsEvaluation)) ?>
