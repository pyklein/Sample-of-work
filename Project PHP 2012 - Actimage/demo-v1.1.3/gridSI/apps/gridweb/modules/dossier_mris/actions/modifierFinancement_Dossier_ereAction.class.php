...
/**
 * Financement d'un dossier ERE
 *
 * @author Jihad
 */
class modifierFinancement_Dossier_ereAction extends gridAction {
  ...
  public function execute($request) {
    ...
    $objDossier = Dossier_ereTable::getInstance()->findOneById($this->dossierId);
    ...
    if ($objDossier)
    {
      ...
      $this->objConvention = Convention_dossier_ereTable::getInstance()->findOneByDossierEreId($this->dossierId);
      ...
      {
        $objVersement = new Versement_dossier_ere();
        $objVersement->setDossierEreId($this->dossierId);

        $this->arrVersements = Versement_dossier_ereTable::getInstance()->getVersementByDossierId($this->dossierId);
        ...
        {
          $this->processForm('creer', "modifierFinancement_Dossier_ere?dossier_id=" . $this->dossierId);
        }
