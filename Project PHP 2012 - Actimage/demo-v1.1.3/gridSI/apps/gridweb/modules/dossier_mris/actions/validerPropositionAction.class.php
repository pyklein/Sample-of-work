...
/**
 * Valider d'un dossier
 *
 * @author Jihad 
 */
class validerPropositionAction extends gridAction {
  ...
  public function execute($objRequeteWeb) {
    ...
    {
      $this->objDossier['statut_'.strtolower($this->strModelContenant). '_id'] = $strStatutDossierTable::VALIDE ;
