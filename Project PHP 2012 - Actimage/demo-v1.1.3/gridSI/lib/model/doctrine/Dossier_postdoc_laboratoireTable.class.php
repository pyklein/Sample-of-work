...
/**
 * Dossier_postdoc_laboratoireTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class Dossier_postdoc_laboratoireTable extends Doctrine_Table {

  /**
   * Returns an instance of this class.
   *
   * @return object Dossier_postdoc_laboratoireTable
   */
  public static function getInstance() {
    return Doctrine_Core::getTable('Dossier_postdoc_laboratoire');
  }
  ...
  public function getLaboratoiresDossier() {
    ...
    $arrDossiersCanon = new Doctrine_Collection('Dossier_postdoc_laboratoire');
   ...
   * s'il n'y a rien, retourne null
   * @param int $regionId Id de la région
   * @return array Tableau de dossier Id
   * @author Alexandre WETTA
   */
  public function retrieveDossierPostdocByRegion($regionId) {
      ...
      if($queryPtsContact->count() != 0){
        ...
        if($queryDossierLabo->count()){
          ...
          foreach($arrDossierLabo as $objDossierLabo){
            $arrDossierId[] = $objDossierLabo->getDossierPostdocId();
          }
