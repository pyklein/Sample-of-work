...
/**
 * Suivi_dossier_ereTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class Suivi_dossier_ereTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object Suivi_dossier_ereTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('Suivi_dossier_ere');
    }

    public function getSuiviByDossierId($intDossierId,$strTypeDossier)
    {
      $q = Doctrine_Query::create()
        -> from ('Suivi_dossier_ere s')
    ...
    public function getSuiviByDossierIdOrderedByType($intDossierId,$strTypeDossier)
    {
      $q = Doctrine_Query::create()
        -> from ('Suivi_dossier_ere s')
        -> where('s.'.$strTypeDossier.'_id = ?',$intDossierId)
        -> orderBy("type_suivi_ere_id ASC, date_demande ASC");
