...
/**
 * Dossier_these_laboratoireTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class Dossier_these_laboratoireTable extends Doctrine_Table {

  /**
   * Returns an instance of this class.
   *
   * @return object Dossier_these_laboratoireTable
   */
  public static function getInstance() {
    return Doctrine_Core::getTable('Dossier_these_laboratoire');
  }
  ...
  public function getLaboratoiresDossier() {
    ...
    $arrDossiersCanon = new Doctrine_Collection('Dossier_these_laboratoire');
   ...
   * @author Alexandre WETTA
   */
  public function retrieveDossierTheseByRegion($regionId) {
      ...
      if($queryPtsContact->count() != 0){
        ...
        if($queryDossierLabo->count()){
          ...
          foreach($arrDossierLabo as $objDossierLabo){
            $arrDossierId[] = $objDossierLabo->getDossierTheseId();
          }
