 ...
 */
class Convention_dossier_ereForm extends BaseConvention_dossier_ereForm {
  ...
  public function configure() {
    ...
    $this->widgetSchema['fichier'] = new sfWidgetFormInputFileEditableJQuery(array(
                'with_delete' => true,
                'label' => libelle("msg_libelle_fichier")."aaa",
    ...
    $this->validatorSchema['fichier'] = new gridValidatorFile(
            array('max_size' => $utilPhp->getMaxUploadSizeEnBytes(),
                  'fichier_bureau' => true,
                  'path' => $this->srvArbo->getRepertoireConventionDossierEre($this->getObject()->getDossierEre()->getNumeroAAfficher()),
                  'required' => false
                  ),
