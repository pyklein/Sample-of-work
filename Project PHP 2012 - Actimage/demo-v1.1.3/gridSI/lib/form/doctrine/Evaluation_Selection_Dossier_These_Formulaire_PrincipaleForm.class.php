...
/**
 * Formulaire principal pour l'évaluation des dossiers de thèses
 *
 * @author Actimage
 */
class Evaluation_Selection_Dossier_These_Formulaire_PrincipaleForm extends BaseDossier_theseForm{
  ...
  public function  configure() {
    ...
    foreach ($this->arrInvitations as $invitation) {
        //on regarde s'il y a déjà une evaluation globale pour le dossier pour cette invitatio
