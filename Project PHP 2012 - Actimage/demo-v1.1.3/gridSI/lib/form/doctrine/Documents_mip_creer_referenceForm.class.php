...
/**
 * Formulaire pour la création de document référencé
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
class Documents_mip_creer_referenceForm extends BaseDocuments_mipForm
{
  ...
  private function configurerLabels()
  {
    ...
    $this->widgetSchema['autre_type'] = new sfWidgetFormInput(array(),array('size' => '50',));
