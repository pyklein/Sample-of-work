...
/**
 * Documents_mip form: Pour la modification d'un document joint
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
class Documents_mipForm extends BaseDocuments_mipForm
{
  public function configure()
  {
    $this->useFields(array('titre', 'documents_mip_type_id', 'autre_type'));
