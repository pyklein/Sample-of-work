 ...
 */
class Aboutissement_ereForm extends BaseAboutissement_ereForm
{
  ...
  {
    $this->widgetSchema['reception_rapport_final']      ->setLabel(libelle('msg_dossier_ere_libelle_date_rapp_fin'));
    $this->widgetSchema['reception_fiche_evaluation']   ->setLabel(libelle('msg_dossier_ere_libelle_date_fich_eval'));
    $this->widgetSchema['reception_synthese']           ->setLabel(libelle('msg_dossier_ere_libelle_date_fich_synt'));
  }
