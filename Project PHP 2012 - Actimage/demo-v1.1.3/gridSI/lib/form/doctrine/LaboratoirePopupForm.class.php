...
/**
 * Formulaire pour le popup laboratoire
 *
 * @author Alexandre WETTA
 */
class LaboratoirePopupForm extends BaseLaboratoireForm {

  public function configure() {

    $this->useFields(array('organisme_id', 'service_id', 'intitule', 'abreviation'));
