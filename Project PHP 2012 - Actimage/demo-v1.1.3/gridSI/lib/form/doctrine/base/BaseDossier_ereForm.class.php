...
/**
 * Dossier_ere form base class.
 *
 * @method Dossier_ere getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseDossier_ereForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                      => new sfWidgetFormInputHidden(),
      'numero_provisoire'       => new sfWidgetFormInputText(),
      'numero_definitif'        => new sfWidgetFormInputText(),
      ...
      'statut_dossier_ere_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Statut_dossier_ere'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'numero_provisoire'       => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'numero_definitif'        => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'statut_dossier_ere_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Statut_dossier_ere'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('dossier_ere[%s]');
