...
/**
 * Session_encadrants_dossier_these form base class.
 *
 * @method Session_encadrants_dossier_these getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseSession_encadrants_dossier_theseForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'role_these_id'     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('RoleThese'), 'required' => false)),
      'transaction_token' => new sfValidatorString(array('max_length' => 20)),
    ));

    $this->widgetSchema->setNameFormat('session_encadrants_dossier_these[%s]');
