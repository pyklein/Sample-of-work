...
/**
 * Convention_dossier_postdoc form base class.
 *
 * @method Convention_dossier_postdoc getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseConvention_dossier_postdocForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('convention_dossier_postdoc[%s]');
  ...
  {
    return 'Convention_dossier_postdoc';
  }
