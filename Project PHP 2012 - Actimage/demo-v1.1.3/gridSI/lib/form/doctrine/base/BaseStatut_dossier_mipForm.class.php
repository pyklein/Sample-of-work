...
/**
 * Statut_dossier_mip form base class.
 *
 * @method Statut_dossier_mip getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseStatut_dossier_mipForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'precedent_statut_dossier_mip_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Precedent'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('statut_dossier_mip[%s]');
