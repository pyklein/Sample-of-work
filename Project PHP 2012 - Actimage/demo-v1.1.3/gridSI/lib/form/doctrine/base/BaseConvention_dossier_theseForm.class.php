...
/**
 * Convention_dossier_these form base class.
 *
 * @method Convention_dossier_these getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseConvention_dossier_theseForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'dossier_these_id'             => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('DossierThese'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'dossier_these_id'             => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('DossierThese'))),
    ...
    $this->widgetSchema->setNameFormat('convention_dossier_these[%s]');
  ...
  {
    return 'Convention_dossier_these';
  }
