...
/**
 * Session_dossier_postdoc_laboratoire form base class.
 *
 * @method Session_dossier_postdoc_laboratoire getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseSession_dossier_postdoc_laboratoireForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('session_dossier_postdoc_laboratoire[%s]');
