...
/**
 * Contentieux form base class.
 *
 * @method Contentieux getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseContentieuxForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('contentieux[%s]');
