...
/**
 * Dossier_postdoc form base class.
 *
 * @method Dossier_postdoc getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseDossier_postdocForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'statut_dossier_postdoc_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Statut_dossier_postdoc'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('dossier_postdoc[%s]');
