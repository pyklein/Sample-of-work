...
/**
 * Engagement form base class.
 *
 * @method Engagement getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseEngagementForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'                 => new sfWidgetFormInputHidden(),
      'type_engagement_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Type_engagement'), 'add_empty' => false)),
      'date_engagement'    => new sfWidgetFormDate(),
    ...
    $this->setValidators(array(
      ...
      'type_engagement_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Type_engagement'))),
      'date_engagement'    => new sfValidatorDate(),
    ...
    $this->widgetSchema->setNameFormat('engagement[%s]');
