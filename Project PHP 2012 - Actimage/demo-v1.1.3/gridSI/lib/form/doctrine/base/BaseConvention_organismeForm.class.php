...
/**
 * Convention_organisme form base class.
 *
 * @method Convention_organisme getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseConvention_organismeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'type_convention_organisme_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TypeConventionOrganisme'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'type_convention_organisme_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TypeConventionOrganisme'))),
      'organisme_id'                 => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Organisme'))),
      'montant'                      => new sfValidatorInteger(),
    ...
    $this->widgetSchema->setNameFormat('convention_organisme[%s]');
