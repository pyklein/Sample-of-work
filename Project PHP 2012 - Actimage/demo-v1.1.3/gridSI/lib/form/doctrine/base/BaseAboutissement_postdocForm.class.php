...
/**
 * Aboutissement_postdoc form base class.
 *
 * @method Aboutissement_postdoc getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseAboutissement_postdocForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('aboutissement_postdoc[%s]');
