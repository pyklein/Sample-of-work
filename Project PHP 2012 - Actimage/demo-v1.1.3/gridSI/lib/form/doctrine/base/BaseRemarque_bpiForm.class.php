...
/**
 * Remarque_bpi form base class.
 *
 * @method Remarque_bpi getObject() Returns the current form's model object
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
abstract class BaseRemarque_bpiForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('remarque_bpi[%s]');
