...
abstract class BaseOrganismeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'type_organisme_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Type_organisme'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'type_organisme_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Type_organisme'))),
