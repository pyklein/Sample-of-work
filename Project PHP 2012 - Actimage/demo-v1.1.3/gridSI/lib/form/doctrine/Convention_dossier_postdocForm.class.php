...
/**
 * Convention_dossier_postdoc form.
 *
 * @package    gridSI
 * @subpackage form
 ...
 */
class Convention_dossier_postdocForm extends BaseConvention_dossier_postdocForm {
  ...
  public function configure() {
    ...
    $this->validatorSchema['fichier'] = new gridValidatorFile(
            array('max_size' => $utilPhp->getMaxUploadSizeEnBytes(),
                  'fichier_bureau' => true,
                  'path' => $this->srvArbo->getRepertoireConventionDossierPostdoc($this->getObject()->getDossierPostdoc()->getNumeroAAfficher()),
                  'required' => false
                  ),
