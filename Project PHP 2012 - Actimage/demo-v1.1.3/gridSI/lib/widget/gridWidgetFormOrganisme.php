 ...
 * @author Gabor JAGER
 */
class gridWidgetFormOrganisme extends sfWidgetFormDoctrineChoice
{
  ...
  {
    $options['model'] = 'Organisme';
    if (!array_key_exists('query', $options)){
      $options['query'] = OrganismeTable::getInstance()->buildQueryOrganismesActifsOrdreAscPourSelectbox();
    }
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    if ($this->getOption('popup'))
    {
      $strRetour .= link_to_grid_popup(' ', "referentiel/creerOrganismePopup", array(
                                        "class" => "picto_court_popup bt_ajouter_popup",
                                        "title"=> libelle("msg_bouton_ajouter_organisme"),
                                        "id" => "ajouter_organisme",
                                        ), false);
    }
