 ...
 */
class Dossier_theseFormFilter extends BaseDossier_theseFormFilter {
  ...
  public function configure() {
   ...
   protected function addNomPrenomEmailColumnQuery($query, $field, $value) {
    if ($value['text'] != '') {
      Dossier_theseTable::getInstance()->appliquerFiltreNomPrenomEmail($query, $value['text']);
    }
  }
