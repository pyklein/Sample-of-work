...
/**
 * Suivi_dossier_ere filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseSuivi_dossier_ereFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'type_suivi_ere_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Type_suivi_ere'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'type_suivi_ere_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Type_suivi_ere'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('suivi_dossier_ere_filters[%s]');
