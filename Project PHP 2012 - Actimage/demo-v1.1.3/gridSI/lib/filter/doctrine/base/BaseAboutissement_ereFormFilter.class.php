...
/**
 * Aboutissement_ere filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseAboutissement_ereFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'dossier_ere_id'             => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Dossier_postdoc'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'dossier_ere_id'             => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Dossier_postdoc'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('aboutissement_ere_filters[%s]');
