...
/**
 * Evenement_mris filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseEvenement_mrisFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('evenement_mris_filters[%s]');
