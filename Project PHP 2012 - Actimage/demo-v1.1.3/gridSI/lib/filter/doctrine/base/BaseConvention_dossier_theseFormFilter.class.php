...
/**
 * Convention_dossier_these filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseConvention_dossier_theseFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('convention_dossier_these_filters[%s]');
