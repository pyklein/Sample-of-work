...
/**
 * Type_engagement filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseType_engagementFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('type_engagement_filters[%s]');
