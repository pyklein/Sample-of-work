...
/**
 * Organisme_mindef filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseOrganisme_mindefFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('organisme_mindef_filters[%s]');
