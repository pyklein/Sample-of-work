...
/**
 * Statut_dossier_bpi filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseStatut_dossier_bpiFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'precedent_statut_dossier_bpi_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Precedent'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('statut_dossier_bpi_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'intitule'                        => 'Text',
      'abreviation'                     => 'Text',
      'precedent_statut_dossier_bpi_id' => 'ForeignKey',
      'est_actif'                       => 'Boolean',
      'created_at'                      => 'Date',
      'updated_at'                      => 'Date',
