...
/**
 * Convention_dossier_postdoc filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseConvention_dossier_postdocFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('convention_dossier_postdoc_filters[%s]');
