...
/**
 * Session_liaison_dossiers_mip_bpi filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseSession_liaison_dossiers_mip_bpiFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('session_liaison_dossiers_mip_bpi_filters[%s]');
