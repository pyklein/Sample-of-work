...
/**
 * Classement_invention_propose filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseClassement_invention_proposeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'propose_id'     => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'propose_id'     => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('classement_invention_propose_filters[%s]');
  ...
  {
    return 'Classement_invention_propose';
  }
