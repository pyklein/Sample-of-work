...
/**
 * Classement_invention_autorite filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseClassement_invention_autoriteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('classement_invention_autorite_filters[%s]');
  ...
  {
    return 'Classement_invention_autorite';
  }
