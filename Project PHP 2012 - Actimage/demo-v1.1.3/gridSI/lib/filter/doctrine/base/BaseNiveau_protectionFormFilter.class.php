...
/**
 * Niveau_protection filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseNiveau_protectionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('niveau_protection_filters[%s]');
