...
/**
 * Versement_dossier_ere filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseVersement_dossier_ereFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('versement_dossier_ere_filters[%s]');
