...
/**
 * Dossier_ere filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseDossier_ereFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'statut_dossier_ere_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Statut_dossier_ere'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('dossier_ere_filters[%s]');
  ...
  public function addLaboratoiresListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('Dossier_ere_laboratoire.laboratoire_id', $values)
    ;
  }
  ...
  public function addAvisMrisListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('Avis_mris_dossier_ere.avis_mris_id', $values)
    ;
  }
  ...
  public function getFields()
  {
    return array(
      ...
      'cotutelle'               => 'Boolean',
      'cooperation'             => 'Boolean',
      'statut_dossier_ere_id'   => 'ForeignKey',
