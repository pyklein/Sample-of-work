...
/**
 * Soutien filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseSoutienFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'date_emission'  => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
    ...
    $this->setValidators(array(
      'date_emission'  => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
    ...
    $this->widgetSchema->setNameFormat('soutien_filters[%s]');
