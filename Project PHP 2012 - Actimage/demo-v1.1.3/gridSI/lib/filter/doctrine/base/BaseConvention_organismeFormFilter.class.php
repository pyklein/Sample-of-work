...
/**
 * Convention_organisme filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseConvention_organismeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('convention_organisme_filters[%s]');
