...
/**
 * Statut_projet_mip filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseStatut_projet_mipFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('statut_projet_mip_filters[%s]');
