...
abstract class BaseOrganismeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'type_organisme_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Type_organisme'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'type_organisme_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Type_organisme'), 'column' => 'id')),
