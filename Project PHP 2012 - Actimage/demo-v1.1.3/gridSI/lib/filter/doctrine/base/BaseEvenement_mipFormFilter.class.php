...
/**
 * Evenement_mip filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseEvenement_mipFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'est_cloture'    => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'evenement'      => new sfValidatorPass(array('required' => false)),
      'est_cloture'    => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
