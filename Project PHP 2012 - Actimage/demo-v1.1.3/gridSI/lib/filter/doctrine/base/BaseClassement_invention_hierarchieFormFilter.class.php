...
/**
 * Classement_invention_hierarchie filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseClassement_invention_hierarchieFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('classement_invention_hierarchie_filters[%s]');
  ...
  {
    return 'Classement_invention_hierarchie';
  }
