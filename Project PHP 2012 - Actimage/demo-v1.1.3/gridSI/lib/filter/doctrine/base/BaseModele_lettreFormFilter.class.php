...
/**
 * Modele_lettre filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseModele_lettreFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('modele_lettre_filters[%s]');
