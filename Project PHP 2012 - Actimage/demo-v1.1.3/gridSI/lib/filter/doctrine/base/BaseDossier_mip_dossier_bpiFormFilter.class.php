...
/**
 * Dossier_mip_dossier_bpi filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseDossier_mip_dossier_bpiFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dossier_mip_dossier_bpi_filters[%s]');
