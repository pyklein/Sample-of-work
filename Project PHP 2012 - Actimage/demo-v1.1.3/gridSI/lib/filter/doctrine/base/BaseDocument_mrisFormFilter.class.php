...
/**
 * Document_mris filter form base class.
 *
 * @package    gridSI
 * @subpackage filter
 ...
 */
abstract class BaseDocument_mrisFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'type_document_these_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Type_document_these'), 'column' => 'id')),
      'type_document_ere_id'     => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Type_document_ere'), 'column' => 'id')),
      'type_document_postdoc_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Type_document_postdoc'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('document_mris_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'type_document_these_id'   => 'ForeignKey',
      'type_document_ere_id'     => 'ForeignKey',
      'type_document_postdoc_id' => 'ForeignKey',
      'created_at'               => 'Date',
      'updated_at'               => 'Date',
